%For IEEE conferences, ICRA, IROS:
...
% \thanks{$^{1}$The authors are with the Biorobotics Laboratory, School of Engineering,
%  \textit{National Autonomous University of Mexico}}
}
...
%\begin{itemize}
% Quitar referencias sobre manipulation en related work. Dejar solo 25 referencias.
% Poner como inline equations las que están sin número después de la 14.
% Quitar ecuaciones 16 y 17.
% Comprimir figura 7.
% Quitar todos los subcations. 
%\end{itemize}

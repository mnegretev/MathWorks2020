  ...
  RuntimeDerivedValuesBundle *rtdv, const double *state, double *motionData)
{
  ...
  xx[62] = 0.03;
  xx[63] = - xx[0];
  xx[64] = 2.387583317164932e-7;
  xx[65] = 0.04;
  xx[68] = - xx[65];
  xx[69] = 0.06499999999956149;
  xx[70] = - xx[64];
  xx[71] = xx[3] * state[1];
  xx[3] = xx[11] * state[1];
  xx[72] = xx[17] * state[1];
  xx[73] = xx[9] * (xx[16] * xx[3] + xx[22] * xx[72]);
  xx[74] = xx[9] * (xx[16] * xx[72] - xx[22] * xx[3]);
  xx[75] = state[1] - xx[9] * (xx[17] * xx[72] + xx[11] * xx[3]) + state[3];
  xx[3] = xx[27] * state[1];
  xx[72] = xx[26] * state[1] + xx[71];
  xx[76] = xx[22] * xx[72];
  xx[77] = xx[12];
  xx[78] = xx[11];
  xx[79] = xx[18];
  xx[80] = xx[22] * xx[3];
  xx[22] = xx[17] * xx[72] + xx[11] * xx[3];
  xx[81] = xx[76];
  xx[82] = - xx[80];
  xx[83] = - xx[22];
  pm_math_Vector3_cross_ra(xx + 77, xx + 81, xx + 84);
  xx[77] = xx[3] + xx[9] * (xx[16] * xx[76] + xx[84]);
  xx[3] = xx[72] + xx[9] * (xx[85] - xx[16] * xx[80]) + xx[23] * state[3];
  xx[23] = xx[9] * (xx[86] - xx[16] * xx[22]);
  xx[78] = xx[29];
  xx[79] = xx[37];
  xx[80] = xx[38];
  xx[81] = xx[30];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 73, xx + 82);
  xx[22] = xx[84] + state[5];
  xx[84] = xx[40];
  xx[85] = xx[41];
  xx[86] = xx[31];
  pm_math_Vector3_cross_ra(xx + 73, xx + 84, xx + 87);
  xx[84] = xx[87] + xx[77];
  xx[85] = xx[88] + xx[3];
  xx[86] = xx[89] + xx[23];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 87);
  xx[78] = xx[42];
  xx[79] = xx[28];
  xx[80] = xx[33];
  xx[81] = xx[34];
  ...
  xx[85] = xx[83];
  xx[86] = xx[22];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 90);
  xx[72] = xx[92] + state[7];
  xx[92] = xx[36];
  xx[93] = xx[43];
  xx[94] = xx[45];
  pm_math_Vector3_cross_ra(xx + 84, xx + 92, xx + 95);
  xx[84] = xx[95] + xx[87];
  xx[85] = xx[96] + xx[88];
  xx[86] = xx[97] + xx[89];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 92);
  xx[76] = xx[92] + xx[10] * state[7];
  xx[78] = xx[44];
  xx[79] = xx[35];
  xx[80] = xx[32];
  xx[81] = xx[47];
  ...
  xx[85] = xx[91];
  xx[86] = xx[72];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 95);
  xx[92] = xx[97] + state[9];
  xx[97] = xx[52];
  xx[98] = xx[53];
  xx[99] = xx[39];
  pm_math_Vector3_cross_ra(xx + 84, xx + 97, xx + 100);
  xx[84] = xx[100] + xx[76];
  xx[85] = xx[101] + xx[93];
  xx[86] = xx[102] + xx[94];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 97);
  xx[78] = xx[50];
  xx[79] = xx[51];
  xx[80] = xx[54];
  xx[81] = xx[48];
  ...
  xx[85] = xx[96];
  xx[86] = xx[92];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 100);
  xx[103] = xx[102] + state[11];
  xx[104] = xx[59];
  xx[105] = xx[60];
  xx[106] = xx[55];
  pm_math_Vector3_cross_ra(xx + 84, xx + 104, xx + 107);
  xx[84] = xx[107] + xx[97];
  xx[85] = xx[108] + xx[98];
  xx[86] = xx[109] + xx[99];
  pm_math_Quaternion_inverseXform_ra(xx + 78, xx + 84, xx + 104);
  xx[78] = xx[104] + xx[56] * state[11];
  xx[107] = xx[57];
  xx[108] = xx[1];
  xx[109] = xx[46];
  xx[110] = xx[61];
  ...
  xx[80] = xx[101];
  xx[81] = xx[103];
  pm_math_Quaternion_inverseXform_ra(xx + 107, xx + 79, xx + 84);
  xx[56] = xx[86] + state[13];
  xx[111] = xx[66];
  xx[112] = xx[67];
  xx[113] = xx[49];
  pm_math_Vector3_cross_ra(xx + 79, xx + 111, xx + 114);
  xx[79] = xx[114] + xx[78];
  xx[80] = xx[115] + xx[105];
  xx[81] = xx[116] + xx[106];
  pm_math_Quaternion_inverseXform_ra(xx + 107, xx + 79, xx + 111);
  xx[79] = xx[62] * xx[85] + xx[111];
  xx[80] = xx[112] - xx[62] * xx[84];
  xx[81] = xx[5] * xx[56];
  xx[86] = xx[0] * xx[81];
  xx[102] = xx[5] * xx[84];
  xx[104] = xx[5] * xx[102];
  ...
  xx[102] = xx[117] + xx[79];
  xx[114] = xx[119] + xx[113];
  xx[115] = xx[5] * xx[114];
  xx[116] = xx[5] * xx[102];
  xx[119] = xx[70];
  xx[120] = xx[65];
  xx[121] = xx[69];
  pm_math_Vector3_cross_ra(xx + 108, xx + 119, xx + 122);
  xx[108] = xx[122] + xx[79];
  xx[109] = xx[124] + xx[113];
  xx[110] = xx[5] * xx[109];
  xx[117] = xx[5] * xx[108];
  motionData[0] = - xx[4];
  motionData[1] = xx[6];
  ...
  motionData[98] = xx[98];
  motionData[99] = xx[99];
  motionData[100] = xx[100];
  motionData[101] = xx[101];
  motionData[102] = xx[103];
  motionData[103] = xx[78];
  motionData[104] = xx[105];
  motionData[105] = xx[106];
  motionData[106] = xx[84];
  motionData[107] = xx[85];
  motionData[108] = xx[56];
  motionData[109] = xx[111];
  motionData[110] = xx[112];
  motionData[111] = xx[113];
  motionData[112] = xx[84];
  motionData[113] = xx[85];
  motionData[114] = xx[56];
  motionData[115] = xx[79];
  motionData[116] = xx[80];
  motionData[117] = xx[113];
  motionData[118] = xx[84] - xx[9] * (xx[86] + xx[104]);
  motionData[119] = xx[85];
  motionData[120] = xx[56] - xx[9] * (xx[107] - xx[81]);
  motionData[121] = xx[102] - xx[9] * (xx[0] * xx[115] + xx[5] * xx[116]);
  motionData[122] = xx[118] + xx[80];
  motionData[123] = xx[114] - xx[9] * (xx[5] * xx[115] - xx[0] * xx[116]);
  motionData[124] = xx[84] + xx[9] * (xx[86] - xx[104]);
  motionData[125] = xx[85];
  motionData[126] = xx[56] - xx[9] * (xx[81] + xx[107]);
  motionData[127] = xx[108] + xx[9] * (xx[0] * xx[110] - xx[5] * xx[117]);
  motionData[128] = xx[123] + xx[80];
  motionData[129] = xx[109] - xx[9] * (xx[0] * xx[117] + xx[5] * xx[110]);
}

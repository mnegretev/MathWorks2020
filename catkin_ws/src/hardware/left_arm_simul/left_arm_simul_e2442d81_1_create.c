  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[14] = {
    { 0, 24, 0, false, 0, 2, "deg", false, true, +1.000000000000000000e+00, true,
    ...
    { 0, 25, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 25, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 26, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },
  ...
  void initDirectFeedthrough(NeDaePrivateData *smData)
{
  ...
  const boolean_T directFeedthroughMatrix[49] = {
  ...
  {
    const int_T status = pm_create_bool_vector_fields(
      &smData->mDirectFeedthroughMatrix, 49, alloc);
    checkMemAllocStatus(status);

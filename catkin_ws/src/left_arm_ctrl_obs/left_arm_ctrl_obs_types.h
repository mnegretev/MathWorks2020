...
//
// File: left_arm_ctrl_obs_types.h
//
...
//
#ifndef RTW_HEADER_left_arm_ctrl_obs_types_h_
#define RTW_HEADER_left_arm_ctrl_obs_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayDimension_
#define DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayDimension_
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayLayout_
#define DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayLayout_
...
typedef struct {
  ...
  SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayDimension Dim[16];

  // IsVarLen=1:VarLenCategory=length:VarLenElem=Dim
  SL_Bus_ROSVariableLengthArrayInfo Dim_SL_Info;
} SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayLayout;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_Float64MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_Float64MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayLayout Layout;
} SL_Bus_left_arm_ctrl_obs_std_msgs_Float64MultiArray;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_Float64_
#define DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_Float64_

// MsgType=std_msgs/Float64
typedef struct {
  real_T Data;
} SL_Bus_left_arm_ctrl_obs_std_msgs_Float64;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_Float32MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_left_arm_ctrl_obs_std_msgs_Float32MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_left_arm_ctrl_obs_std_msgs_MultiArrayLayout Layout;
} SL_Bus_left_arm_ctrl_obs_std_msgs_Float32MultiArray;
...
#ifndef typedef_emxArray_char_T_left_arm_ctrl_T
#define typedef_emxArray_char_T_left_arm_ctrl_T

typedef struct emxArray_char_T emxArray_char_T_left_arm_ctrl_T;

#endif                                 //typedef_emxArray_char_T_left_arm_ctrl_T
...
#ifndef typedef_emxArray_real_T_left_arm_ctrl_T
#define typedef_emxArray_real_T_left_arm_ctrl_T

typedef struct emxArray_real_T emxArray_real_T_left_arm_ctrl_T;

#endif                                 //typedef_emxArray_real_T_left_arm_ctrl_T
...
#ifndef typedef_e_cell_wrap_left_arm_ctrl_obs_T
...
#ifndef typedef_rigidBodyJoint_left_arm_ctrl__T
#define typedef_rigidBodyJoint_left_arm_ctrl__T
...
} rigidBodyJoint_left_arm_ctrl__T;

#endif                                 //typedef_rigidBodyJoint_left_arm_ctrl__T
...
typedef struct {
  ...
  rigidBodyJoint_left_arm_ctrl__T JointInternal;
  real_T ParentIndex;
...
typedef struct {
  emxArray_char_T_left_arm_ctrl_T *Type;
  emxArray_real_T_left_arm_ctrl_T *MotionSubspace;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
  real_T JointAxisInternal[3];
...
typedef struct {
  int32_T isInitialized;
  k_robotics_manip_internal_R_e_T TreeInternal;
...
#endif                                 //typedef_k_robotics_manip_internal__e0_T

#ifndef typedef_robotics_slmanip_internal__e0_T
#define typedef_robotics_slmanip_internal__e0_T

typedef struct {
  int32_T isInitialized;
  k_robotics_manip_internal__e0_T TreeInternal;
} robotics_slmanip_internal__e0_T;

#endif                                 //typedef_robotics_slmanip_internal__e0_T

#ifndef typedef_f_cell_wrap_left_arm_ctrl_obs_T
#define typedef_f_cell_wrap_left_arm_ctrl_obs_T

typedef struct {
  real_T f1[36];
} f_cell_wrap_left_arm_ctrl_obs_T;

#endif                                 //typedef_f_cell_wrap_left_arm_ctrl_obs_T
...
typedef struct {
  e_cell_wrap_left_arm_ctrl_obs_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
typedef struct tag_RTM_left_arm_ctrl_obs_T RT_MODEL_left_arm_ctrl_obs_T;

#endif                                 // RTW_HEADER_left_arm_ctrl_obs_types_h_

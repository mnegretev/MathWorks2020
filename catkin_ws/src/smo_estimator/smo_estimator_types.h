...
//
#ifndef RTW_HEADER_smo_estimator_types_h_
#define RTW_HEADER_smo_estimator_types_h_
#include "rtwtypes.h"

// Model Code Variants
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_Float64_
#define DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_Float64_

// MsgType=std_msgs/Float64
typedef struct {
  real_T Data;
} SL_Bus_smo_estimator_std_msgs_Float64;
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_MultiArrayDimension_
#define DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_MultiArrayDimension_
...
typedef struct {
  ...
  uint32_T Size;
  uint32_T Stride;
} SL_Bus_smo_estimator_std_msgs_MultiArrayDimension;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_MultiArrayLayout_
#define DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_MultiArrayLayout_
...
typedef struct {
  ...
  SL_Bus_smo_estimator_std_msgs_MultiArrayDimension Dim[16];

  // IsVarLen=1:VarLenCategory=length:VarLenElem=Dim
  SL_Bus_ROSVariableLengthArrayInfo Dim_SL_Info;
} SL_Bus_smo_estimator_std_msgs_MultiArrayLayout;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_Float64MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_smo_estimator_std_msgs_Float64MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_smo_estimator_std_msgs_MultiArrayLayout Layout;
} SL_Bus_smo_estimator_std_msgs_Float64MultiArray;
...
#ifndef typedef_emxArray_char_T_smo_estimator_T
#define typedef_emxArray_char_T_smo_estimator_T

typedef struct emxArray_char_T emxArray_char_T_smo_estimator_T;

#endif                                 //typedef_emxArray_char_T_smo_estimator_T
...
#ifndef typedef_emxArray_real_T_smo_estimator_T
#define typedef_emxArray_real_T_smo_estimator_T

typedef struct emxArray_real_T emxArray_real_T_smo_estimator_T;

#endif                                 //typedef_emxArray_real_T_smo_estimator_T
...
#ifndef typedef_ssoOm1dpzkll0ActLkI75EE_smo_e_T
#define typedef_ssoOm1dpzkll0ActLkI75EE_smo_e_T

typedef struct tag_ssoOm1dpzkll0ActLkI75EE ssoOm1dpzkll0ActLkI75EE_smo_e_T;

#endif                                 //typedef_ssoOm1dpzkll0ActLkI75EE_smo_e_T
...
#ifndef typedef_sb1GSy5uAZojAgyRiXnSERH_smo_e_T
#define typedef_sb1GSy5uAZojAgyRiXnSERH_smo_e_T

typedef struct tag_sb1GSy5uAZojAgyRiXnSERH sb1GSy5uAZojAgyRiXnSERH_smo_e_T;

#endif                                 //typedef_sb1GSy5uAZojAgyRiXnSERH_smo_e_T
...
#ifndef typedef_f_cell_wrap_smo_estimator_T
#define typedef_f_cell_wrap_smo_estimator_T

typedef struct tag_8EP4ctv7s0SDnh3V6WCLOG f_cell_wrap_smo_estimator_T;

#endif                                 //typedef_f_cell_wrap_smo_estimator_T
...
{
  emxArray_char_T_smo_estimator_T *Type;
  real_T PositionNumber;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
...
#ifndef typedef_c_rigidBodyJoint_smo_estimato_T
#define typedef_c_rigidBodyJoint_smo_estimato_T

typedef struct tag_2xAJzS7rvIyFzfuC7FOGlD c_rigidBodyJoint_smo_estimato_T;

#endif                                 //typedef_c_rigidBodyJoint_smo_estimato_T
...
{
  emxArray_char_T_smo_estimator_T *NameInternal;
  c_rigidBodyJoint_smo_estimato_T JointInternal;
  real_T ParentIndex;
};
...
#ifndef typedef_f_cell_wrap_smo_estimator_m_T
#define typedef_f_cell_wrap_smo_estimator_m_T

typedef struct tag_pGgszObO16I6TGXaEMnuXB f_cell_wrap_smo_estimator_m_T;

#endif                                 //typedef_f_cell_wrap_smo_estimator_m_T
...
{
  emxArray_char_T_smo_estimator_T *Type;
  emxArray_real_T_smo_estimator_T *MotionSubspace;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
  real_T JointAxisInternal[3];
};
...
#ifndef typedef_c_rigidBodyJoint_smo_estima_m_T
#define typedef_c_rigidBodyJoint_smo_estima_m_T

typedef struct tag_QsLFVUgAtzQUBY1V99co0D c_rigidBodyJoint_smo_estima_m_T;

#endif                                 //typedef_c_rigidBodyJoint_smo_estima_m_T
...
{
  real_T Index;
  c_rigidBodyJoint_smo_estima_m_T JointInternal;
  real_T ParentIndex;
  real_T SpatialInertia[36];
};
...
#ifndef typedef_o_robotics_manip_internal_R_m_T
#define typedef_o_robotics_manip_internal_R_m_T

typedef struct tag_IYTryndM9hCl2aQvRVOEpC o_robotics_manip_internal_R_m_T;

#endif                                 //typedef_o_robotics_manip_internal_R_m_T
...
#ifndef typedef_p_robotics_manip_internal_R_m_T
#define typedef_p_robotics_manip_internal_R_m_T

typedef struct tag_Y04n94zUMq8rhLX3OxwtfD p_robotics_manip_internal_R_m_T;

#endif                                 //typedef_p_robotics_manip_internal_R_m_T
...
{
  real_T NumBodies;
  p_robotics_manip_internal_R_m_T Base;
  o_robotics_manip_internal_R_m_T *Bodies[10];
  real_T VelocityNumber;
  real_T PositionDoFMap[20];
  real_T VelocityDoFMap[20];
};
...
#ifndef typedef_q_robotics_manip_internal_R_m_T
#define typedef_q_robotics_manip_internal_R_m_T

typedef struct tag_adHmrPvDKD0ArwdbUi0kXC q_robotics_manip_internal_R_m_T;

#endif                                 //typedef_q_robotics_manip_internal_R_m_T
...
{
  int32_T isInitialized;
  q_robotics_manip_internal_R_m_T TreeInternal;
};
...
typedef struct tag_XelI9Pmf5IifkfUX35naJD robotics_slmanip_internal_b_m_T;
...
#ifndef typedef_q_robotics_manip_internal__mr_T
#define typedef_q_robotics_manip_internal__mr_T

typedef struct tag_vHfXEiuA3KFu0p3XQ6SOuG q_robotics_manip_internal__mr_T;

#endif                                 //typedef_q_robotics_manip_internal__mr_T
...
{
  int32_T isInitialized;
  q_robotics_manip_internal__mr_T TreeInternal;
};

#endif                                 //struct_tag_JaIDC5o8TCYfAaNTPWKJe

#ifndef typedef_robotics_slmanip_internal__mr_T
#define typedef_robotics_slmanip_internal__mr_T

typedef struct tag_JaIDC5o8TCYfAaNTPWKJe robotics_slmanip_internal__mr_T;

#endif                                 //typedef_robotics_slmanip_internal__mr_T
...
{
  f_cell_wrap_smo_estimator_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
#ifndef typedef_emxArray_f_cell_wrap_smo_esti_T
#define typedef_emxArray_f_cell_wrap_smo_esti_T

typedef struct emxArray_tag_8EP4ctv7s0SDnh3V6W emxArray_f_cell_wrap_smo_esti_T;

#endif                                 //typedef_emxArray_f_cell_wrap_smo_esti_T
...
{
  f_cell_wrap_smo_estimator_m_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
#ifndef typedef_emxArray_f_cell_wrap_smo_es_m_T
#define typedef_emxArray_f_cell_wrap_smo_es_m_T

typedef struct emxArray_tag_pGgszObO16I6TGXaEM emxArray_f_cell_wrap_smo_es_m_T;

#endif                                 //typedef_emxArray_f_cell_wrap_smo_es_m_T

// Parameters (default storage)
typedef struct P_smo_estimator_T_ P_smo_estimator_T;

// Forward declaration for rtModel
typedef struct tag_RTM_smo_estimator_T RT_MODEL_smo_estimator_T;

#endif                                 // RTW_HEADER_smo_estimator_types_h_

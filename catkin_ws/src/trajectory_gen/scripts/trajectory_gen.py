...
def main():
    ...
    rospy.Subscriber("/hardware/la_goal_pose", Float64MultiArray, callback_goal_pose)
    rospy.Subscriber("/hardware/la_current_pose", Float64MultiArray, callback_current_pose)
    pub_goal_trajectory = rospy.Publisher("/hardware/la_goal_trajectory", Float32MultiArray, queue_size=10)
